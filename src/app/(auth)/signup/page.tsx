...
const quotes = [
  'Every great shoot starts with the right team. Build yours here.',
  'Your next collaboration is one profile away.',
  'The network you build today is the reputation you carry forever.',
]
const quote = quotes[Math.floor(Math.random() * quotes.length)]

const roles = ['Photographers', 'Videographers', 'Makeup Artists', 'Models', 'Musicians', 'Stylists', 'Art Directors']
    ...
    <div className="min-h-screen bg-dark flex">
      ...
      <div className="hidden lg:block relative w-[55%] overflow-hidden flex-shrink-0">
        ...
        <img
          ...
          loading="eager"
        />
        {/* Gradients: directional fade toward form + bottom vignette */}
        ...
        <div className="relative h-full flex flex-col justify-between p-10 xl:p-14">
          ...
          <div className="max-w-xs">
            ...
            <p className="text-xs text-white/50 leading-relaxed">
              Launching in Orlando, FL · Free to join · 35+ creative roles
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 overflow-y-auto">
        <div className="w-full max-w-sm">
          ...
          <div className="mb-6 lg:text-left text-center">
            ...
            <p className="text-text-muted text-sm">Be among the first creatives on Dotshot</p>
          </div>
